  ...
  public void onClick(View v) {
    ...
    if (v == playVideoButton) {
      intent = YouTubeStandalonePlayer.createVideoIntent(
          this, DeveloperKey.DEVELOPER_KEY_ANDROID, VIDEO_ID, startTimeMillis, autoplay, lightboxMode);
    } else if (v == playPlaylistButton) {
      intent = YouTubeStandalonePlayer.createPlaylistIntent(this, DeveloperKey.DEVELOPER_KEY_ANDROID,
          PLAYLIST_ID, startIndex, startTimeMillis, autoplay, lightboxMode);
    } else if (v == playVideoListButton) {
      intent = YouTubeStandalonePlayer.createVideosIntent(this, DeveloperKey.DEVELOPER_KEY_ANDROID,
